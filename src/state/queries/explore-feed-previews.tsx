  ...
  const query = useInfiniteQuery({
    ...
    queryFn: async ({pageParam}) => {
      ...
      return {
        feed,
        /*
         * `FeedAPI`/`FeedAPIResponse` are still old-world (shared by every
         * feed API class, not just this one) - the runtime shape is the same
         * either way.
         */
        posts: data.feed as unknown as app.bsky.feed.defs.FeedViewPost[],
      }
    },
    initialPageParam: 0,
