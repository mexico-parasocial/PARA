...
export function CabildeoNominationSection({
  cabildeoUri,
}: {
  cabildeoUri: string
}) {
          ...
          {nominations.map(nom => (
            <View
              ...
              <View
                ...
                <Text
                  style={[styles.roleTagText, {color: t.palette.primary_500}]}>
                  {nom.reason}
                </Text>
              </View>
              <Text style={[styles.supportCount, t.atoms.text_contrast_medium]}>
